# Canadian Chronic Disease Surveillance (Asthma)

#   Created algorithms using predictive analytics and machine learning techniques to help predict which age 
#   groups would be most susceptible to asthma (a Chronic Disease in Canada) in the upcoming years and which 
#   type of doctor would each age group visit regarding their health.

# Import the dataset and renamed the dataset to 'df3'

modified_ccdss.scsmc.eng <- read.csv("C:/Users/VP/Desktop/initial code/modified_ccdss-scsmc-eng.csv")
